...
CTE Map Idol Manager (The Extension / 插件本体): The code for this extension is Open Source for personal modification and learning. However, Commercial Use is Strictly Prohibited. You may not sell, rent, or use this code for any profit-making activities. 本扩展的代码部分为 开源项目，仅供个人修改和学习使用。但是，绝对禁止任何形式的商业用途。不得将此代码用于售卖、租赁或任何盈利性活动。
